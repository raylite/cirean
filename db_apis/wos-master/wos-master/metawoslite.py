class MetaWosLite():
    ...
    def get_authors(self):
        ...
        """
        return str(self.metadata["authors"][0]["value"])
    ...
    def get_title(self):
        ...
        """
        return str(self.metadata["title"][0]["value"][0])
    ...
    def get_ids(self):
        ...
        for id_type in self.metadata["other"]:
            ...
            ids[str(id_type["label"])] = [str(i) for i in id_type["value"]]
        return ids
    ...
    def get_source(self):
        ...
        for s in self.metadata["source"]:
            source_data[str(s["label"])] = [str(v) for v in s["value"]]
        return source_data
